class BudgetIncomesController < ApplicationController
  ...
  def create
    ...
    if the_budget_income.valid?
      ...
      redirect_to("/budget_incomes", { :notice => "Budget income created successfully." })
    else
      redirect_to("/budget_incomes", { :alert => the_budget_income.errors.full_messages.to_sentence })
    end
  end
  ...
  def update
    ...
    if the_budget_income.valid?
      the_budget_income.save
      redirect_to("/budget_incomes/#{the_budget_income.id}", { :notice => "Budget income updated successfully."} )
    else
  ...
  def destroy
    ...
    redirect_to("/budget_incomes", { :notice => "Budget income deleted successfully."} )
  end
end
